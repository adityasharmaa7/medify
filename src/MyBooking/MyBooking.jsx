...
import SearchBooking from '../Components/DynamicComponents/SearchBooking/SearchBooking';
...
function MyBooking() {
    ...
    useEffect(() => {
        ...
        console.log(JSON.parse(localBookings));
      }, []);
      ...
      >
          ...
          <Container maxWidth="xl" sx={{ px: { xs: 0, md: 5 } }}>
            ...
            >
              ...
              <Box
                ...
                width={{ xs: 1, md: "auto" }}
              >
                <SearchBooking list={bookings} filterList={setFilteredBookings} />
              </Box>
            </Stack>
          </Container>
        </Box>
        ...
        <Container maxWidth="xl" sx={{ pt: 8, pb: 10, px: { xs: 0, md: 4 } }}>
          <Stack alignItems="flex-start" direction={{ md: "row" }}>
            ...
            >
                <img src={cta} width={"100%"} height="auto" />
            </Box>
          </Stack>
        </Container>
        <Footer/>
